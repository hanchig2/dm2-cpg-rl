...
# V12 communication-augmented DM2 tasks.
gym.register(
    id="DM2-Message-CPG-Mixed-Unitree-A1-K1-v0",
    entry_point=(
...
gym.register(
    id="DM2-Message-CPG-Flat-Unitree-A1-K1-Eval-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Message-CPG-Rough-Unitree-A1-K1-Eval-Mild-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Message-CPG-Rough-Unitree-A1-K1-Eval-Moderate-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
# V15 relation-aware recurrent-graph DM2 tasks.
gym.register(
    id="DM2-Graph-CPG-Mixed-Unitree-A1-K1-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-CPG-Flat-Unitree-A1-K1-Eval-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-CPG-Rough-Unitree-A1-K1-Eval-Mild-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-CPG-Rough-Unitree-A1-K1-Eval-Moderate-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-Distill-CPG-Flat-Unitree-A1-K1-Eval-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2TeacherCPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-Distill-CPG-Rough-Unitree-A1-K1-Eval-Mild-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2TeacherCPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Graph-Distill-CPG-Rough-Unitree-A1-K1-Eval-Moderate-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2TeacherCPGUnitreeA1Env"
    ),
...
# V17 bounded anchored-graph distillation tasks.
gym.register(
    id="DM2-Anchored-Graph-Distill-CPG-Mixed-Unitree-A1-K1-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2TeacherCPGUnitreeA1Env"
    ),
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": (
            "cpg.tasks.cpg.agents."
            "dm2_rsl_rl_ppo_cfg:"
            "DM2AnchoredGraphDistillationCPGUnitreeA1MixedRunnerCfg"
        ),
    },
)
...
gym.register(
    id=(
        "DM2-Anchored-Graph-Distill-CPG-Flat-"
        "Unitree-A1-K1-Eval-v0"
    ),
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
...
gym.register(
    id=(
        "DM2-Anchored-Graph-Distill-CPG-Rough-"
        "Unitree-A1-K1-Eval-Mild-v0"
    ),
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
