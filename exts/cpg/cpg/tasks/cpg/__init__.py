...
# V13 relation-preserving communication tasks.
gym.register(
    id="DM2-Structured-CPG-Mixed-Unitree-A1-K1-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": (
            "cpg.tasks.cpg.agents."
            "dm2_rsl_rl_ppo_cfg:"
            "DM2StructuredMessageCPGUnitreeA1MixedPPORunnerCfg"
        ),
    },
)

gym.register(
    id="DM2-Structured-CPG-Flat-Unitree-A1-K1-Eval-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Structured-CPG-Rough-Unitree-A1-K1-Eval-Mild-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Structured-CPG-Rough-Unitree-A1-K1-Eval-Moderate-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Frozen-Residual-CPG-Mixed-Unitree-A1-K1-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": (
            "cpg.tasks.cpg.agents."
            "dm2_rsl_rl_ppo_cfg:"
            "DM2FrozenResidualCPGUnitreeA1MixedPPORunnerCfg"
        ),
    },
)

gym.register(
    id="DM2-Frozen-Residual-CPG-Flat-Unitree-A1-K1-Eval-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Frozen-Residual-CPG-Rough-Unitree-A1-K1-Eval-Mild-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
...
gym.register(
    id="DM2-Frozen-Residual-CPG-Rough-Unitree-A1-K1-Eval-Moderate-v0",
    entry_point=(
        "cpg.tasks.cpg.dm2_cpg_env:"
        "DM2CPGUnitreeA1Env"
    ),
